...
# distilbert_tokenizer = DistilBertTokenizer.from_pretrained(file)
roberta_tokenizer = RobertaTokenizer.from_pretrained(file)
    ...
    with codecs.open(file_path, mode='r', encoding='UTF8') as input_file:
        ...
        for line in input_file:
            ...
            if essay_set == prompt_id or prompt_id <= 0:
                ...
                tokenized_text = roberta_tokenizer.tokenize(sent_tokens)
                max_num = 512
                indexed_tokens = roberta_tokenizer.convert_tokens_to_ids(tokenized_text)
