...
def prepare_sentence_data(datapaths, prompt_id=1):
    ...
    if datapaths is None:
        datapaths = [
            "/content/drive/MyDrive/Big Data/LLMs in Education/Autho Scoring Essay-NPCR Model/data-set/asap/fold_1/train.tsv",
            "/content/drive/MyDrive/Big Data/LLMs in Education/Autho Scoring Essay-NPCR Model/data-set/asap/fold_1/dev.tsv",
            "/content/drive/MyDrive/Big Data/LLMs in Education/Autho Scoring Essay-NPCR Model/data-set/asap/fold_1/test.tsv"
        ]
